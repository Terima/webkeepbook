...
<head>
    ...
    <title>KeepBook - @yield('title')</title>
            ...
            <aside class="main-sidebar col-12 col-md-3 col-lg-2 px-0">
                <div class="main-navbar">
                    <nav class="navbar align-items-stretch navbar-dark bg-dark flex-md-nowrap border-bottom p-0">
                        <a class="navbar-brand w-100 mr-0" href="{{url(route('backend_dashboard'))}}"
                            style="line-height: 25px;">
                            <div class="d-table m-auto">
                                <img id="main-logo" class="d-inline-block align-top mr-1 rounded-circle"
                                    style="max-width: 25px;" src="{{asset('keep tr.png')}}" alt="KeepBook Dashboard">
                                <span class="d-none d-md-inline ml-1 white">KeepBook Dashboard</span>
                            </div>
                        </a>
